...
[[opsi-setup-detector]]
=== opsi Setup Detector (opsi-setup-detector) (frei)

[[opsi-setup-detector-use-quickstart]]
==== opsi Setup Detector (opsi-setup-detector) Quickstart
...
image::opsi-setup-detector_config_dlg_de.png["Konfigurationsdialog",width=300]
...
image::opsi-setup-detector_page_start_de.png["Startpage",width=400]
...
Ein Setup-Programm um den opsi-setup-detector auch ohne opsi zu installieren, ist in Vorbereitung.
...
image::opsi-setup-detector_page_create_modes_with_opb_de.png["Create and Build Modes",width=400]
...
OPSI-SETUP-DETECTOR Notwendige Konfiguration beim ersten Start
image::opsi-setup-detector_config_dlg_de.png["Konfigurationsdialog",width=200]
...
.OPSI-SETUP-DETECTOR Start
image::opsi-setup-detector_page_start_de.png["Startpage",width=500]

.OPSI-SETUP-DETECTOR Analyse
image::opsi-setup-detector_page_analyze_de.png["Analyse",width=500]

.OPSI-SETUP-DETECTOR Ergebnis der Analyse
image::opsi-setup-detector_page_setup1_de.png["Ergebnis der Analyse",width=500]
...
image::opsi-setup-detector_page_product1_de.png["Produktkonfiguration 1",width=500]
...
image::opsi-setup-detector_page_product2_de.png["Produktkonfiguration 2",width=500]

.OPSI-SETUP-DETECTOR Produkt erzeugen
image::opsi-setup-detector_page_create_de.png["Produkt erzeugen",width=500]
...
image::opsi-setup-detector_page_setup2_de.png["Ergebnis der Analyse 2",width=500]
...
Sicher werden Sie im Rahmen der Arbeit mit dem opsi-setup-detector mal auf die Meldung `Unkonown Installer` stoßen. Dann hat der opsi-setup-detector das Installer-Framework mit dem dieser Installer gemacht ist nicht erkannt. +
Vorschläge: +
