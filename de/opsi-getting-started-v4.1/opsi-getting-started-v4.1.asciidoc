...
Desweiteren wird hier eine `changelog.txt` Datei angelegt, in welcher die Unterschiede zwischen den einzelnen Paket- und Programmversionen dokumentiert werden können.
...
.Beispiel einer 'changelog.txt' Datei
