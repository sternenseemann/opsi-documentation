...
image::osd_config_dlg_en.png["Konfigurationsdialog",width=300]
...
.opsi-setup-detector Notwendige Konfiguration beim ersten Start
image::osd_config_dlg_en.png["Konfigurationsdialog",width=200]
...
image::osd_page_analyze_en.png["Analyse",width=500]

.opsi-setup-detector Ergebnis der Analyse
image::osd_page_setup1_en.png["Ergebnis der Analyse",width=500]
...
image::osd_page_product1_en.png["Produktkonfiguration 1",width=500]
...
image::osd_page_product2_en.png["Produktkonfiguration 2",width=500]

.opsi-setup-detector Produkt erzeugen
image::osd_page_create_en.png["Produkt erzeugen",width=500]
...
image::osd_page_setup2_en.png["Ergebnis der Analyse 2",width=500]
