...
Furthermore a file named `changelog.txt` may be used to document the differences between different package and program versions.
...
.Example of a `changelog.txt` file:
